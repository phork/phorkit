...
import { textbox as variants, sizes } from './helpers/variants.js';
...
<Playground>
  <ThemeWrapper>
    <Looper
      ...
      render={variant => (
        <Rhythm py={3}>
          <FormComponentDemo type="textbox" property="value" initialValue="Hello world" key={variant} unwrapped>
...
<Playground>
  <StateWrapper initialState={false}>
    {({ state: isFocused, setState: setFocused }) => (
      <FormComponentDemo type="textbox" property="value">
        <Textbox
...
<Playground>
  <ThemeWrapper contrast>
    <Looper
      ...
      render={variant => (
        <Rhythm py={3}>
          <FormComponentDemo type="textbox" property="value" contrast key={variant} unwrapped>
            <Textbox
              clearable
              contrast
              iconBefore={<SearchIcon />}
