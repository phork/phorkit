...
import { InvalidStateColor, MergeElementProps, ThemeProps } from '../../../types';
...
export type LabelProps<T extends React.ElementType = 'div'> = {
  as?: T;
} & MergeElementProps<T, LocalLabelProps>;
