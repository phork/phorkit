...
export default {
  ...
  parameters: {
    ...
    docs: {
      page: () => (
        <React.Fragment>
          <PageTitle src="compositions/Tooltip" title="PortalTooltip" />
          <Subtitle />
          <Description />
          <Primary />
...
} as ComponentMeta<typeof PortalTooltip>;

const Template: ComponentStory<(args: PortalTooltipProps<HTMLButtonElement>) => ReturnType<typeof PortalTooltip>> =
  args => <PortalTooltip<HTMLButtonElement> {...args} />;
...
const defaultArgs = {
  ...
  initialVisible: true,
  layout: 'vertical' as PortalTooltipProps['layout'],
  observe: false,
  permanent: false,
