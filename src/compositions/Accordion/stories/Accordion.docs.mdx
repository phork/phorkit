...
import { DeepFocusConsumer, SetDeepFocusConsumer } from 'context/DeepFocus';
        ...
        content: ({ selected }) => (
          <Rhythm pl={5} pr={3} py={3}>
            <Paper full bordered={['vertical', 'bottom']} color="primary">
              <Flex full alignItems="center" direction="row" justifyContent="space-between">
                <Rhythm mr={4}>
                  <Flex full direction="row" justifyContent="space-between">
                    <span>First panel{selected ? ' is selected' : ''}</span>
                    <Typography size="small" volume="quiet">
                      {new Date().getTime()}
                    </Typography>
                  </Flex>
                </Rhythm>
            ...
            <Paper full bordered={['vertical', 'bottom']} color="primary">
              <Flex full alignItems="flex-start" direction="row" justifyContent="space-between">
                <Rhythm grouped mr={2} my={3}>
                  ...
                  <p>
                    This doesn&apos;t use a function to render like the others, because the focused state isn&apos;t
                    referenced. Expanding and collapsing siblings won&apos;t re-render the content here.
                  </p>
                  <p>
