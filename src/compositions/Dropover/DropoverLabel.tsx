...
export const DropoverLabel = React.forwardRef<HTMLDivElement, DropoverLabelProps>(
  (
    ...
    const triangleColor =
      initTriangleColor ||
      (contrast ? themes[themeId]['contrast-palette-quiet-color'] : themes[themeId]['primary-palette-text-color']);

    const triangleFocusedColor =
      initTriangleFocusedColor ||
      (contrast ? themes[themeId]['contrast-palette-accent-color'] : themes[themeId]['primary-palette-accent-color']);
